...
type KeyDefinition struct {
	...
	NormalizeParams func(ctx context.Context, rt model.APIClient, params map[string]string) error `json:"-"`
	...
	Process func(ctx context.Context, rt model.APIClient, raw *model.RawEvent, params map[string]string) (json.RawMessage, error) `json:"-"`
	...
	Match func(raw *model.RawEvent, params map[string]string) bool `json:"-"`
	...
	// idempotency note.
	PreConsume func(ctx context.Context, rt model.APIClient, params map[string]string) (cleanup func() error, err error) `json:"-"`
